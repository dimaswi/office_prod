...
class SuratPolicy
{
    ...
    {
        return $user->can('view_any_surat');
    }
    ...
    {
        return $user->can('delete_any_surat');
    }
    ...
    {
        return $user->can('force_delete_any_surat');
    }
    ...
    {
        return $user->can('restore_any_surat');
    }
